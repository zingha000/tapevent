              ...
              isDense: true,
                  ...
                  FutureBuilder<Map<String, dynamic>?>(
                    ...
                    builder: (context, snap) {
                      final name = (snap.data?['full_name'] as String?) ?? supabase.auth.currentUser?.userMetadata?['full_name'] as String? ?? 'Pengguna';
                      return Padding(
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<List<Event>>(
                                      ...
                                      builder: (context, snap2) {
                                        final count = snap2.data?.length ?? 0;
                                        return Text(
